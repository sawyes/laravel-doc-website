...
## LiteIDE
  ...
  ![](/assets/go/images/1.4.liteide.png?raw=true)
...
## Sublime Text
  ...
  - 自动化提示代码,如下图所示
	...
	![](/assets/go/images/1.4.sublime1.png?raw=true)
  ...
  - 支持项目管理
	...
	![](/assets/go/images/1.4.sublime2.png?raw=true)
...
```
  ...
  ![](/assets/go/images/1.4.sublime3.png?raw=true)
  ...
  ![](/assets/go/images/1.4.sublime4.png?raw=true)
...
![](/assets/go/images/1.4.vim.png?raw=true)
...
Emacs传说中的神器，她不仅仅是一个编辑器，它是一个整合环境，或可称它为集成开发环境，这些功能如让使用者置身于全功能的操作系统中。
  ...
  ![](/assets/go/images/1.4.emacs.png?raw=true)
...
Eclipse也是非常常用的开发利器，以下介绍如何使用Eclipse来编写Go程序。
  ...
  ![](/assets/go/images/1.4.eclipse1.png?raw=true)
...
5. 配置插件
  ...
  ![](/assets/go/images/1.4.eclipse2.png?raw=true)
  ...
  ![](/assets/go/images/1.4.eclipse3.png?raw=true)

  图1.13 设置gocode信息

  (3).配置GDB（可选，做调试用），设置GDB路径为MingW安装目录下的gdb.exe文件

  ![](/assets/go/images/1.4.eclipse4.png?raw=true)
...
6. 测试是否成功
	...
	新建一个go工程，再建立一个hello.go。如下图：
	  ...
	  ![](/assets/go/images/1.4.eclipse5.png?raw=true)
	
	  图1.15 新建项目编辑文件
	
	调试如下（要在console中用输入命令来调试）：
	
	  ![](/assets/go/images/1.4.eclipse6.png?raw=true)
