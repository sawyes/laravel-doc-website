...
![](/assets/go/images/6.4.hijack.png?raw=true)
...
![](/assets/go/images/6.4.cookie.png?raw=true)
...
![](/assets/go/images/6.4.setcookie.png?raw=true)

图6.6 模拟cookie

回车后，你将看到如下内容：

![](/assets/go/images/6.4.hijacksuccess.png?raw=true)
